...
export default class MfaDevices extends LitElement {
  ...
  deviceDisplay(device, displayTrash = false) {
    return html`
      <div class="d-flex align-items-center justify-content-between p-3 m-3" style="border-color: var(--info); box-shadow: 2px 2px 10px 5px var(--brand-color--bg-shadow);">
  ...
  listDisplay() {
    return html`
    <div class="d-flex flex-column" class="max-height: 500px;">
      <div class="mx-3">
        <h3 class="d-flex align-items-center justify-content-center">
          <span>Security Keys</span>
        </h3>
      ...
      <div class="d-flex justify-content-center">
        <div>
          <button class="create-button btn btn-sm" @click="${() => { this.state = states.NEW; this.requestUpdate(); }}">
