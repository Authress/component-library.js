...
/**
* @preserve
* Authress Component Library ${version.replace()} - This is the Authress web component library. It provides full featured web components to provide easy and direct integration with Authress.
* License: Apache-2.0
* Repo   : https://github.com/Authress/component-library.js
